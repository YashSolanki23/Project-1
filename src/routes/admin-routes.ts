...
import { deleteUserController, getUsersController, updateUserController } from "../modules/auth/admin.controller";
...
adminRoute.patch("/users/:id/role",updateUserController)
